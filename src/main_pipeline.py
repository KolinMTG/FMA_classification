...
def main_pipeline() -> None:
    ...
    # model = build_and_compile_model_03(
    #     model_name="cnn_64x344_enhanced",

    #     # New input adapted to log-mel settings
    #     input_shape=(64, 344, 1),
    ...
    #     model=model,
    #     tfrecord_dir=TFRECORD_OUTPUT_DIR_64,
    ...
    #     save=True,
    #     model_save_dir=ModelsCSV.TRAINING_DIR,
    #     model_registry_csv=ModelsCSV.PERFORMANCE,
