...
SEGMENT_DURATION: float = (
    4.0  # in seconds duration of a segment (part of the audio file)
)
SEGMENT_OVERLAP: float = (
    0.5  # overlap between segments 0.5 = 50% overlap, is  a good compromise between data augmentation and redundancy
)
